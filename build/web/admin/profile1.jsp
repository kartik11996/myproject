 ...
 <div class="row">
              <div class="col-md-9">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="profile2.jsp" method="post" />
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="text-input">Name</label>
                        <div class="col-md-9">
                          <input class="form-control"  id="text-input" type="text" name="T1" value="<%= a %>" placeholder="Enter your name" required>
